classdef ic_MDCKtools_profile_controller
...
%             profile_def.Export.Plotter_Width_Px = 400;
    ...
    methods
        ...
        function obj = ic_MDCKtools_profile_controller()
            folder = getapplicationdatadir('MDCKtools',true,true);
            subfolder = [folder filesep 'Profiles']; 
            if ~exist(subfolder,'dir')
                mkdir(subfolder)
            end
            obj.profile_file = [ subfolder filesep 'MDCKtoolsPrefs.mat' ];
        end
        ...
        function set_profile(obj)
            ...
            set(f,'Name','ic_MDCKtools Preferences',...
                  'NumberTitle', 'off', ...
                  'Toolbar','none',...
                  'MenuBar','none');
