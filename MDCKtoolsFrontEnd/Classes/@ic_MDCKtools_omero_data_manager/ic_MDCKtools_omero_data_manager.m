...
classdef ic_MDCKtools_omero_data_manager < handle 
    ...
    methods
        ...
        function obj = ic_MDCKtools_omero_data_manager(varargin)            
        ...
        function Omero_logon(obj,~) 
            ...
            if ~ispref('ic_MDCKtoolsFrontEnd','OMEROlogin')
           ...
           if isempty(obj.logon{4})
               if neverTriedLog == true
                   ...
                   if strcmp(ret_string,'Yes')
                        addpref('ic_MDCKtoolsFrontEnd','NeverOMERO','On');
                   end
               end
               return
           end
